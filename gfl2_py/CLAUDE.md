...
| `stat_ocr_v0_1_0.py` | Blob + projection/Hu OCR for DG stat numbers (pct and val lines); the `v0_1_0` engine (class `StatOcrV0_1_0`), the default for `main.py --stat-ocr-engine` (formerly called "production"; renamed as part of a project-wide engine-versioning cleanup, action_items.txt #29) |
